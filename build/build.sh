...
cd ../static/js
cat knockout-2.1.0.js date.js include.js viewModel.js hideAddressBar.js highcharts/highcharts.js chartOptions.js heartRate.js > ../../build/heartRate.concat.js
cd ../../build
